...
import pe.hotelho.hotel.facade.HabitacionesFacade;
...
public class HabitacionesController implements Serializable {
    ...
    private Habitaciones current;
    private DataModel items = null;
    @EJB
    private pe.hotelho.hotel.facade.HabitacionesFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Habitaciones) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("HabitacionesCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("HabitacionesUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("HabitacionesDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class HabitacionesControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Habitaciones) {
                ...
                return getStringKey(o.getIdhabitaciones());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Habitaciones.class.getName());
            }
        }
    }
}
